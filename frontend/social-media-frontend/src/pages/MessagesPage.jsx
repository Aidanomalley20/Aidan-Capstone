...
const MessagesPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center  p-4">
      <div className="bg-white shadow-md rounded-lg p-4 w-full max-w-2xl flex items-center justify-between mb-4">
      ...
      <div className="flex-grow overflow-y-auto bg-white p-4 w-full max-w-2xl rounded-lg shadow-md">
        {loading ? (
      ...
      <div className="flex items-center w-full max-w-2xl mt-4 bg-white p-2 rounded-lg shadow-md">
        <input
          type="text"
